...
/// Health status indicator for system checks
pub enum HealthStatus {
    /// System is operating normally
    Healthy,
    /// System is operational but showing warning signs
    Degraded,
    /// System is not healthy and may require attention
    Unhealthy,
}
...
pub struct HealthCheck {
        ...
        pub message: String,
    /// Current value being checked (e.g., CPU percentage)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub value: Option<f64>,
    /// Threshold value that triggers degraded/unhealthy status
    #[serde(skip_serializing_if = "Option::is_none")]
