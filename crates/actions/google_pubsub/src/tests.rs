...
async fn test_subscription_lifecycle() {
    ...
    // Get subscription
    let get_result = get_subscription(
        "my-project".to_string(),
        "my-subscription".to_string(),
    ).await;
    ...
    // Delete subscription
    let delete_result = delete_subscription(
        "my-project".to_string(),
        "my-subscription".to_string(),
    ).await;
...
async fn test_snapshot_lifecycle() {
    ...
    assert!(create_result.success);
    assert_eq!(
        create_result.snapshot_name,
        "projects/my-project/snapshots/my-snapshot"
    );

    // Delete snapshot
    let delete_result = delete_snapshot(
        "my-project".to_string(),
        "my-snapshot".to_string(),
    ).await;
