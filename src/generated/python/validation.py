...
class ValidationErrorLog(BaseModel):
    ...
    rule_id: Optional[str] = Field(default=None, description="Reference: ValidationRule.id")
    rule_set_id: Optional[str] = Field(default=None, description="Reference: ValidationRuleSet.id")
