...
/// Count Tokens
pub async fn count_tokens(content: &str, model: Option<&str>) -> Result<CountTokensOutput, String> {
    unimplemented!("count_tokens")
}

/// List Available Models
pub async fn list_models(page_size: Option<i32>, page_token: Option<&str>) -> Result<ListModelsOutput, String> {
    unimplemented!("list_models")
}

/// Get Model Info
pub async fn get_model(model: &str) -> Result<GetModelOutput, String> {
