...
class CloudflareEnvVariable(BaseModel):
    """
...
class CloudflareSecretsStore(BaseModel):
    """
...
class CloudflareSecretsStoreSecret(BaseModel):
    """
...
class CloudflareVersionMetadata(BaseModel):
    """
