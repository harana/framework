...
class CfDurableObjectNamespace(BaseModel):
    """
...
class CfDurableObjectInstance(BaseModel):
    """
...
class CfDurableObjectStorageEntry(BaseModel):
    """
...
class CfDurableObjectAlarm(BaseModel):
    """
...
class CfDurableObjectWebsocket(BaseModel):
    """
